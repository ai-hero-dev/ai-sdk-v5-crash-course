...
export const searchFilesSchema = z.object({
	pattern: z.string().describe("The search pattern (supports * wildcard)"),
	searchDir: z.string().optional().describe("The directory to search in (defaults to current directory)"),
});
